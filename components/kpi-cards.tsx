  ...
  const kpis = [
    {
      ...
      icon: ShieldCheck,
      color: coverageRate >= 95 ? "text-emerald-600 dark:text-emerald-400" : "text-amber-600 dark:text-amber-400",
      bgColor: coverageRate >= 95 ? "bg-emerald-50 dark:bg-emerald-950/50" : "bg-amber-50 dark:bg-amber-950/50",
    },
    {
      ...
      icon: AlertTriangle,
      color: openExceptions === 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400",
      bgColor: openExceptions === 0 ? "bg-emerald-50 dark:bg-emerald-950/50" : "bg-red-50 dark:bg-red-950/50",
    },
    {
    ...
    },
    {
      ...
      icon: DollarSign,
      color: cashAtRisk === 0 ? "text-emerald-600 dark:text-emerald-400" : "text-red-600 dark:text-red-400",
      bgColor: cashAtRisk === 0 ? "bg-emerald-50 dark:bg-emerald-950/50" : "bg-red-50 dark:bg-red-950/50",
    },
  ]
